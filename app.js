...
game.gymStatus = function () {
    ...
    for (let i = 0; i < game.gyms.length; i++) {
        if (game.gyms[i].completed === true) {
            gymTally.completed += +1; console.log(game.gyms[i])
        } else {
            gymTally.incomplete += +1;
        }
    }
    console.log(gymTally.incomplete + ' this is gymTally')
    return gymTally
}
...
*/
game.completeDifficultybelow8 = function () {
    for (let i = 0; i < game.gyms.length; i++) {
